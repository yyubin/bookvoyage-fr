    ...
    <footer className="mt-16 border-t border-[var(--border)] pt-8 text-sm text-[var(--muted)]">
      <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-center">
        ...
        <div className="flex flex-wrap gap-4 text-xs font-semibold">
          ...
          <button className="transition hover:text-[var(--ink)]">이용약관</button>
          <button className="transition hover:text-[var(--ink)]">
            개인정보처리방침
          </button>
          <button className="transition hover:text-[var(--ink)]">고객센터</button>
          <button className="transition hover:text-[var(--ink)]">문의하기</button>
        </div>
      </div>
